...
import c from "./alphabet/Stable.module.css";
...
const WorkId = (p) => {
  ...
  return (
    <div style={{ width: "156px", height: "220px" }}>
      <table className={`${c["letter-s"]} ${c.pad}`}>
        <tr>
      ...
      <table className={`${c["letter-s"]} ${c.rotB}`}>
        <tr>
      ...
      <table className={`${c["letter-s"]} ${c.rotA}`}>
        <tr>
        ...
        <tr>
          <td className={c.corner} style={colorDays(filtredData, 26, p.date)}>
            <span>26</span>
          </td>
        ...
        <tr>
          ...
          <td className={c.corner} style={colorDays(filtredData, 31, p.date)}>
            <span>31</span>
          </td>
        </tr>
      </table>
