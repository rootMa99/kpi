  ...
  return (
    <table className={c["letter-s"]}>
      <tr>
        ...
        <td className={c.top}></td>
        <td className={c.top}></td>
        <td className={c.corner} style={colorDays(filtredData, 1, p.date)}><span>1</span></td>
      ...
      <tr>
        <td className={c.corner} rowSpan="2" style={colorDays(filtredData, 9, p.date)}><span>9</span></td>
