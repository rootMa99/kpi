...
const Ptable = (p) => {
  ...
  return (
    <table className={c["letter-s"]}>
      <tr>
        <td className={c.corner} colSpan="2" style={colorDays(filtredData, 1)}><span>1</span></td>
      ...
      <tr>
        <td className={c.corner} colSpan="2" style={colorDays(filtredData, 29)}><span>29</span></td>
        <td className={c.corner} style={colorDays(filtredData, 30)}><span>30</span></td>
        <td className={c.corner} style={colorDays(filtredData, 31)}><span>31</span></td>
        <td className={c.top}></td>
        <td className={c.top}></td>
        <td className={c.top}></td>
        <td className={c.top}></td>
